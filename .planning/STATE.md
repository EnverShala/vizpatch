...
**Phase 4 — Web-UI & Multi-Kunde. Entscheidung 2026-07-12: Phase 4 wird vorgezogen (vor Vor-Ort-Termin Phase 3), damit der erste Kunde (Esso Tankstelle Leonberg West) bereits die Browser-UI bekommt. Phase 3 (Tuning) läuft parallel nach Live-Schaltung.**
...
| 4 — Web-UI & Multi-Kunde | 📋 Planned (5 plans, 5 waves) | 2026-07-12 | — |

## Phase-4-Plans (geplant 2026-07-12, sequentielle Waves)
