...
- [x] 08-03-PLAN.md — Mail-Kontext übers Outlook-Objektmodell (defensiv) + Settings-Dialog (DPAPI, Cert-Trade-off)
- [x] 08-04-PLAN.md — ClickOnce-/LAN-/HTTPS-Runbook + struktureller Kein-Auto-Send-Quellwächter + Live-Abnahme (Werkzeuge/Gate/Draft)
...
- [x] 12-01-PLAN.md — entwurf_mit_anhang-Werkzeug + Pending-Upload-Store + MIME-Bau + Guard-Sync (ATT-02/04/05)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 12-02-PLAN.md — Upload-Endpoint /chat/{id}/upload (Streaming, MAX_ATTACHMENT_MB) + attachment_meta-Durchreichen (ATT-01/03)
