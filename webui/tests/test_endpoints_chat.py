...
def test_index_and_embed_share_identical_chat_fragment_markup(authed_client, mocker, tmp_path, monkeypatch):
    ...
    shared_fragment = (
        ...
        '  <div id="chat-toolbar">\n'
        '    <button type="button" id="chat-connect-btn" title="Verknüpfungs-Datei herunterladen, um das Outlook-Add-in auf einem anderen PC automatisch zu konfigurieren">&#x1F517; Mit Outlook verknüpfen</button>\n'
