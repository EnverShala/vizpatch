...
Deckt ab:
(a) GET /addin/taskpane.html ohne Auth -> 401
(b) mit Auth -> 200, Dropdown mit angelegten Agenten + iframe auf /chat/{id}/embed
...
def test_addin_taskpane_requires_auth(authed_client, tmp_path, monkeypatch):
